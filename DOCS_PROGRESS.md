...
documentados a fondo. **75 de 552 archivos leídos** (estado por archivo en
...
mobiliario, y toda la ruta de monetización, y la estructura de los interactuables, y el inventario. Los ~477 archivos restantes son sistemas de juego (interactuables, karaoke,
...
del arranque. Refleja: 10 páginas de arquitectura + 7 de casas + 8 de sistemas +
3 de referencia + 27 candidatos a bug con evidencia, frente a un plan que aún necesita
...
| Analizado (leído entero, descrito en el sitio) | 58 |
| Analizado (en parte) | 15 |
| Pendiente | 477 |
...
Veintisiete entradas, todas redactadas al completo en
...
`docs/testing/verification-plan.md` — **creado**, 27 entradas, cada una con condiciones de
...
- **Páginas del sitio:** `docs/intro.md`, 10 de arquitectura, 7 de casas, 8 de sistemas,
...
- **Diagramas:** 37 diagramas Mermaid (flowchart, sequence, state)
- **Candidatos a bug:** 27 redactados al completo, incluida una pasada de seguridad
- **Scripts leídos:** 75 de 552
...
Máquinas, Karaoke (25 remotes), Paint, Misiones, Trabajos, Animación, Cocina,
Construcción, y `ToolPlacementServer` (880 líneas). Unos 435 archivos. De uno en uno, y un commit por sistema.

...
ROOT = "src"
ANALYSED = {
    "src/ServerStorage/Templates/SettingsTemplate.luau",
    "src/ServerStorage/Templates/TemplateJob.luau",
    "src/ServerStorage/Templates/TemplateUIS.luau",
...
THIRD_PARTY_PREFIXES = tuple(t(x) + "/" for x in (
    ...
    # DataKit: paquete externo con su propio sitio (arclyne.github.io/data-kit).
    # Sus clases principales SI se leyeron y estan en ANALYSED/PARTIAL, que van antes
    # que esta comprobacion; lo que cae aqui es el interior que no se abrio.
    "Core/ServerStorage/DataKit",
)) + (t("Core/ReplicatedStorage/Shared/Trove.luau"),
      t("Core/ReplicatedStorage/Shared/Signal.luau"))
# Spring.luau (31 lineas) y lerp.luau (5) son de terceros pero se leyeron enteros:
# van en ANALYSED, porque decir "no se lee por dentro" de cinco lineas seria falso.
ANALYSED |= {
    ...
    t("Core/ReplicatedStorage/ShopSettings.luau"),
    t("Core/ServerStorage/RoleService/RolesGroup.luau"),
    t("Core/ReplicatedStorage/Shared/Karaoke/CrearCancion/Generos.luau"),
    t("Core/ReplicatedStorage/Shared/Karaoke/RevisarCanciones/AttributesRequerest.luau"),
    t("Core/ReplicatedStorage/Shared/Nametag/GroupRoles/init.luau"),
    t("Core/ServerScriptService/ServerScripts/Quests/QuestMain.server.luau"),
    t("Core/ServerScriptService/ServerScripts/Quests/Pickables/QuestPickableService.luau"),
    t("Core/ReplicatedStorage/Shared/Spring.luau"),
    t("Core/ReplicatedStorage/Shared/lerp.luau"),
    t("Core/ReplicatedStorage/Shared/JobSystem/Bartender.luau"),
    t("Core/ReplicatedStorage/Shared/JobSystem/LimpiarPiso.luau"),
    t("Core/ReplicatedStorage/Shared/JobSystem/CajasTransport/init.luau"),
    t("Core/ServerScriptService/ServerScripts/Referrals/ReferralCommands.server.luau"),
    t("BuildingSystem/ReplicatedStorage/BuildInterface/ConstructionModeModule/init.luau"),
    t("BuildingSystem/ReplicatedStorage/BuildInterface/ConstructionModeModule/ColorFormat.luau"),
...
PARTIAL = {
    t("Core/ReplicatedStorage/Shared/GuideService/READ ME.client.luau"),
    t("Core/ReplicatedStorage/Client/BusquedaSettings.luau"),
    t("Core/ReplicatedStorage/Shared/Quests/QuestConfig.luau"),
    t("Core/ReplicatedStorage/Shared/Quests/QuestShared.luau"),
    t("Core/ReplicatedStorage/Client/ReferralClient/ReferralClient.server.luau"),
    t("Core/ReplicatedStorage/Shared/Referrals/ReferralShared.luau"),
    t("Core/ReplicatedStorage/Shared/Referrals/ProgressRing.luau"),
    t("Core/ReplicatedStorage/Client/inventory/init.server.luau"),
    t("Core/ReplicatedStorage/Client/inventory/InventoryWheel.luau"),
    t("Core/ReplicatedStorage/Client/inventory/InventoryList/init.luau"),
    t("Core/ReplicatedStorage/Client/inventory/InventoryList/InventoryItem/init.luau"),
    t("Core/ReplicatedStorage/Shared/Paint/Paint/init.luau"),
    t("Core/ReplicatedStorage/Shared/Paint/Paint/Save.luau"),
    t("Core/ReplicatedStorage/Shared/Paint/Paint/PaletteColor.luau"),
    t("Core/ReplicatedStorage/Shared/Paint/Load/init.luau"),
    t("Core/ReplicatedStorage/Shared/Paint/Load/LoadFrame/init.luau"),
    t("Core/ReplicatedStorage/Shared/Paint/Load/LoadFrame/Frames.luau"),
    t("Core/ReplicatedStorage/Shared/Paint/Create/init.luau"),
    t("Core/ReplicatedStorage/Shared/Paint/FormatPinturaData/SplitRespectingBrackets.luau"),
    t("Core/ReplicatedStorage/Shared/Paint/ServerClient/Marcos.server.luau"),
    t("Core/ReplicatedStorage/Shared/pong/Ball.luau"),
    t("Core/ReplicatedStorage/Shared/pong/Paddle.luau"),
    t("Core/ReplicatedStorage/Shared/pong/Input.luau"),
    t("Core/ReplicatedStorage/Shared/pong/createPongSession.luau"),
    t("Core/ReplicatedStorage/Shared/Karaoke/CrearCancion/Attributes.luau"),
    t("Core/ReplicatedStorage/Shared/Karaoke/CrearCancion/Generos.luau"),
    t("Core/ReplicatedStorage/Shared/Karaoke/RevisarCanciones/AttributesRequerest.luau"),
    t("Core/ReplicatedStorage/Shared/Karaoke/RevisarCanciones/Script.server.luau"),
    t("Core/ReplicatedStorage/Shared/Nametag/GroupRoles/init.luau"),
    t("Core/ReplicatedStorage/Shared/BartenderSystem/Instance/ActionsBartender.luau"),
    t("Core/ReplicatedStorage/Shared/GuideService/PageController/InterfaceController/init.luau"),
    t("Core/ReplicatedStorage/BannersConfig.luau"),
    t("Core/ReplicatedStorage/ShopSettings.luau"),
    t("Core/ServerStorage/RoleService/RolesGroup.luau"),
    t("Core/ServerStorage/GlobalDataStore/Testeo_GlobalDataStore.luau"),
    t("Core/ServerScriptService/ServerScripts/cooking/interactables/CuttingBoard.server.luau"),
    ...
    t("BuildingSystem/ReplicatedStorage/BuildInterface/ConstructionModeModule/Main/FurnitureFrame/init.luau"),
    t("BuildingSystem/ReplicatedStorage/BuildInterface/ConstructionModeModule/Main/init.luau"),
    t("BuildingSystem/ReplicatedStorage/BuildInterface/ConstructionModeModule/Main/Inventory/init.luau"),
    t("BuildingSystem/ReplicatedStorage/BuildInterface/ConstructionModeModule/Main/DesingFrame/init.luau"),
    t("BuildingSystem/ReplicatedStorage/BuildInterface/ConstructionModeModule/Color/init.luau"),
    t("BuildingSystem/ReplicatedStorage/BuildInterface/ConstructionModeModule/MoveAndPlaceent/init.luau"),
...
for dp, _, fn in os.walk(ROOT):
    for f in sorted(fn):
        ...
        if p in DOCUMENTED:
            ...
            # Una lectura registrada gana siempre a la etiqueta general de frontera:
            # DataKit/Store.luau se leyo en parte y eso no debe perderse.
